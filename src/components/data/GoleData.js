...
export const researchExp = [
  {
    date: "October 2020 – Till date",
    details: (
      <p>
        <b>Assistant professor</b>, Department of Chemistry
        <br /> Shiv Nadar University, Delhi NCR, India
      </p>
    ),
  },
  {
    ...
    details: (
      <p>
        ...
        <br /> University of Bordeaux, France
      </p>
    ),
  },
  {
...
export const awrdRec = [
  {
    date: "2021",
    details: (
      <p>
        <b>Ramanujan Fellowship</b>
        <br /> SERB, Department of Science & Technology, Government of India
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    details: (
      <p>
        <b>Bristol-Myers Squibb fellowship</b>
        <br /> For excellency in Ph.D. in chemical science
        <br /> in the academic year 2009-11 by Indian Institute of Science
      </p>
    ),
  },
  {
    ...
    details: (
      <p>
        <b>Dr. A. Nagaraja Rao Medal</b>
        <br /> For the best student of Integrated, Ph.D. (MS level) in
        <br /> Chemical sciences at the institute during 2009-10
  ...
  },
  {
    ...
    details: (
      <p>
        <b>Vasudevamurthy-Soundararajan Prize</b>
        <br />
        For the best performance in course work during 2009-10
